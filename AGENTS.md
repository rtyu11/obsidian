...
| 「Ankiを更新して」「英単語をAnkiに追加して」 | `.agents/skills/kindle_vocab_anki/SKILL.md` |
...
| 「Ankiを更新して」「英単語をAnkiに追加して」 | `.agents/skills/kindle_vocab_anki/SKILL.md` | GEMINI_API_KEY要設定。Anki起動＋AnkiConnectアドオン必須（コード: 2055492159）|
